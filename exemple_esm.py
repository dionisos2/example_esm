...
distribution_factory = Distribution_factory(create_2_people(), create_transitions_2())
...
# distribution_2_people = distribution_factory.create_distribution(distribution_2_people)
